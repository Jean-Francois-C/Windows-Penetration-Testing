...
- Implement direct or indrect syscalls to improve stealth (because the use of 'VirtualAlloc' with 'PAGE_READWRITE' then 'VirtualProtect' to executable presents a risk of detection).
