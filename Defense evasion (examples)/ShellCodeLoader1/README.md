...
``` 
<i/>Optional - You can compress and obfuscate the shellcodeloader executable with a packer like "ConfuserEx" but it is not necessary in order to bypass most AV solutions.</i>
